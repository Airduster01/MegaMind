...
describe('MM Console Store Audit Operations Survey No Answers', () => {
    const path = require('path');
    it("will navigate the MM Console Operations Survey No Answers", async () => {
    ...
    await $('aria/0002').waitForClickable();
    await $('aria/0002').click();
    ...
    await $('#question_q1_answer > label:nth-child(2) > span.ant-radio.ant-wave-target > input').click();
    await $('#question_q1_text').setValue('Testing Required Comment section...');
    await browser.pause(500);
    await $('#question_q1_photos').setValue(remotePath1);
    await browser.pause(500);
    //Parking Availability?
    await $('#question_q2_answer > label:nth-child(2) > span.ant-radio.ant-wave-target > input').click();
    await $('#question_q2_text').setValue('Testing Required Comment section...');
    await browser.pause(500);
    await $('#question_q2_photos').setValue(remotePath2);
    await browser.pause(500);
    //Office and Restroom Clean?
    await $('#question_q3_answer > label:nth-child(2) > span.ant-radio.ant-wave-target > input').click();
    await $('#question_q3_text').setValue('Testing Required Comment section...');
    await $('#question_q3_photos').setValue(remotePath3);
    await browser.pause(500);

    //Team Member in Porper Attire?
    await $('#question_q4_answer > label:nth-child(2) > span.ant-radio.ant-wave-target > input').click();
    await $('#question_q4_text').setValue('Testing Required Comment section...');
    await browser.pause(500);

    //Office Posters & Signage Compliancy
    await $('#question_q5_answer > label:nth-child(2) > span.ant-radio.ant-wave-target > input').click();
    await $('#question_q5_text').setValue('Testing Required Comment section...');
    await browser.pause(500);
    await $('#question_q5_photos').setValue(remotePath1);
    await browser.pause(500);

    //Does the MSN QR code work?  
    await $('#question_q5a_answer > label:nth-child(2) > span.ant-radio.ant-wave-target > input').click();
    ...
    await $('#question_q5b_answer > label:nth-child(2) > span.ant-radio.ant-wave-target > input').click();
    ...
    await $('#question_q6_answer > label:nth-child(2) > span.ant-radio.ant-wave-target > input').click();
    await $('#question_q6_text').setValue('Testing Required Comment section...');
    await browser.pause(500);
    await $('#question_q6_photos').setValue(remotePath2);
    await browser.pause(500);
    //Inspect company units for cleanliness, safety, and account accuracy in SSM
    await $('#question_q7_answer > label:nth-child(2) > span.ant-radio.ant-wave-target > input').click();
    await $('#question_q7_text').setValue('Testing Required Comment section...');
    await browser.pause(500);
    await $('#question_q7_photos').setValue(remotePath3);
    await browser.pause(500);
    //Drive Aisles, Hallways, Elevator & Dumpster clean, free of trash, debris
    await $('#question_q8_answer > label:nth-child(2) > span.ant-radio.ant-wave-target > input').click();
    await $('#question_q8_text').setValue('Testing Required Comment section...');
    await browser.pause(500);
    await $('#question_q8_photos').setValue(remotePath1);
    await browser.pause(500);
    //Inspect 5 vacant units with PM for cleanliness
    await $('#question_q9_answer > label:nth-child(2) > span.ant-radio.ant-wave-target > input').click();
    await $('#question_q9_text').setValue('Testing Required Comment section...');
    await browser.pause(500);
    ...
    await $('#question_q10_answer > label:nth-child(2) > span.ant-radio.ant-wave-target > input').click();
    await $('#question_q10_text').setValue('Testing Required Comment section...');
    await browser.pause(500);
    await $('#question_q10_photos').setValue(remotePath2);
    await browser.pause(500);
    //Verify Google directions to property & Business information is accurate
    await $('#question_q11_answer > label:nth-child(2) > span.ant-radio.ant-wave-target > input').click();
    await $('#question_q11_text').setValue('Testing Required Comment section...');
    await browser.pause(500);
    await $('#question_q11_photos').setValue(remotePath3);
    await browser.pause(500);
    //Conduct a merchandise count and ensure display is fully stocked
    await $('#question_q12_answer > label:nth-child(2) > span.ant-radio.ant-wave-target > input').click();
    await $('#question_q12_text').setValue('Testing Required Comment section...');
    await browser.pause(500);
    await $('#question_q12_photos').setValue(remotePath1);
    await browser.pause(500);
    //New Move-In verification
    await $('#question_q13_answer > label:nth-child(2) > span.ant-radio.ant-wave-target > input').click();
    await $('#question_q13_text').setValue('Testing Required Comment section...');
    await browser.pause(500);
    await $('#question_q13_photos').setValue(remotePath2);
    await browser.pause(500);
    //Move Out Verification
    await $('#question_q14_answer > label:nth-child(2) > span.ant-radio.ant-wave-target > input').click();
    await $('#question_q14_text').setValue('Testing Required Comment section...');
    await browser.pause(500);
    await $('#question_q14_photos').setValue(remotePath3);
    await browser.pause(500);
    //Store phone # active/E911 functional (933)
    await $('#question_q15_answer > label:nth-child(2) > span.ant-radio.ant-wave-target > input').click();
    await $('#question_q15_text').setValue('Testing Required Comment section...');
    await browser.pause(500);
    await $('#question_q15_photos').setValue(remotePath1);
    await browser.pause(500);
    //Verify PM weekly walk thru in The Vault
    await $('#question_q16_answer > label:nth-child(2) > span.ant-radio.ant-wave-target > input').click();
    ...
    await $('#question_q17_answer > label:nth-child(2) > span.ant-radio.ant-wave-target > input').click();
    await $('#question_q17_text').setValue('Testing Required Comment section...');
    await browser.pause(500);
    await $('#question_q17_photos').setValue(remotePath3);
    await browser.pause(500);
    //PBI/KPI Performance
    await $('#question_q18_answer > label:nth-child(2) > span.ant-radio.ant-wave-target > input').click();
    await $('#question_q18_text').setValue('Testing Required Comment section...');
    await browser.pause(500);
    await $('#question_q18_photos').setValue(remotePath1);
    await browser.pause(500);
    //Check email signature for company standardization
    await $('#question_q19_answer > label:nth-child(2) > span.ant-radio.ant-wave-target > input').click();
    await $('#question_q19_text').setValue('Testing Required Comment section...');
    await browser.pause(500);
    await $('#question_q19_photos').setValue(remotePath2);
    await browser.pause(500);
    //Review open Jira tickets for additional follow up
    await $('#question_q20_answer > label:nth-child(2) > span.ant-radio.ant-wave-target > input').click();
    ...
    await $('#question_q21_answer > label:nth-child(2) > span.ant-radio.ant-wave-target').waitForClickable();
    await $('#question_q21_answer > label:nth-child(2) > span.ant-radio.ant-wave-target').click();
    ...
    await $('#question_q22_answer > label:nth-child(2) > span.ant-radio.ant-wave-target').waitForClickable();
    await $('#question_q22_answer > label:nth-child(2) > span.ant-radio.ant-wave-target').click();
